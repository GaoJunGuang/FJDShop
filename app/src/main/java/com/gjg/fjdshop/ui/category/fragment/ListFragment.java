...
import com.gjg.fjdshop.ui.category.adapter.CategoryLeftAdapter;
import com.gjg.fjdshop.ui.category.adapter.CategoryRightAdapter;
...
public class ListFragment extends BaseFragment {
    ...
    private List<CategoryBean.ResultBean> result;
...
//                    Toast.makeText(mContext, "http", Toast.LENGTH_SHORT).show();
                    if (response != null) {
                        ...
                        if (isFirst) {
                            leftAdapter = new CategoryLeftAdapter(mContext);
                        ...
                        //解析右边数据
                        CategoryRightAdapter rightAdapter = new CategoryRightAdapter(mContext, result);
    ...
    private void processData(String json) {
        Gson gson = new Gson();
        CategoryBean typeBean = gson.fromJson(json, CategoryBean.class);
