...
import com.gjg.fjdshop.ui.shoppingcart.pay.PayResult;
import com.gjg.fjdshop.ui.shoppingcart.pay.SignUtils;
...
public class ShoppingCartFragment extends BaseFragment implements View.OnClickListener {
    ...
    public void pay(View v) {
        ...
        String orderInfo = getOrderInfo("您购买的商品", "商品的详细描述", adapter.getTotalPrice()+"");
