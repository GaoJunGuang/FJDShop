package com.gjg.fjdshop.ui.shoppingcart.utils;

import android.content.Context;
import android.text.TextUtils;
import android.util.SparseArray;

import com.gjg.fjdshop.app.MyApplication;
import com.gjg.fjdshop.ui.home.bean.GoodsBean;
import com.gjg.fjdshop.utils.CacheUtils;
...
public class CartStorage {
    ...
    private static CartStorage instance_cart;
    ...
    public static CartStorage getInstance(){
        if(instance_cart==null){
            instance_cart=new CartStorage(MyApplication.getContext());
        }
        return instance_cart;
    }
